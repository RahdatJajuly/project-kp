				...
				<div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
					<div class="p-4 m-3">
						<h5 class="text-dark font-weight-normal pt-5 mt-5">Aplikasi <span
								class="font-weight-bold">Inventaris Barang
								SMK REFORMASI</span></h5>
						...
						<form method="POST" action="{{ route('login') }}" class="needs-validation" novalidate="">
							...
							<div class="form-group">
								...
								<input id="email" type="email" class="form-control @error('email') is-invalid @enderror"
									name="email" tabindex="1" placeholder="Masukan alamat email.." required autofocus>
				...
				<div class="col-lg-8 col-12 order-lg-2 order-1 min-vh-100 background-walk-y position-relative overlay-gradient-bottom"
					...
					<div class="absolute-bottom-left index-2">
						<div class="text-light p-5 pb-2">
							...
							<marquee scrolldelay='300'> SMK REFORMASI</marquee>
							<!---
